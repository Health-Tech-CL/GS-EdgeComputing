...
#define TOPICO_SUBSCRIBE    "/TEF/hosp230/cmd"        //tópico MQTT de escuta
#define TOPICO_PUBLISH      "/TEF/hosp230/attrs"      //tópico MQTT de envio de informações para Broker
#define TOPICO_PUBLISH_2    "/TEF/hosp230/attrs/l"    //tópico MQTT de envio de informações para Broker
#define TOPICO_PUBLISH_3    "/TEF/hosp230/attrs/h"    //tópico MQTT de envio de informações para Broker
#define TOPICO_PUBLISH_4    "/TEF/hosp230/attrs/t"    //tópico MQTT de envio de informações para Broker
                                                      //IMPORTANTE: recomendamos fortemente alterar os nomes
                                                      //            desses tópicos. Caso contrário, há grandes
                                                      //            chances de você controlar e monitorar o ESP32
                                                      //            de outra pessoa.
#define ID_MQTT  "fiware_230"   //id mqtt (para identificação de sessão)
...
// Saídas Leds
const int pinBuzzer = 33;       // Led builtin do ESP32 (led na placa)
